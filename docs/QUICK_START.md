...
### Optional compound eye (camera):
- Pick a `camera.*` entity if you want real ommatidia (snapshots ~every 30s)
- Leave blank to keep lights+sun synthesis
- Needs Pillow (HA installs from manifest requirements)
...
_P.S. — Away? Peek via [vome.io](https://vome.io). Optional: [fynd.vome.io](https://fynd.vome.io)._
